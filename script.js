...
class MessengerApp {
    ...
    handleLogin() {
        ...
        // Загружаем из localStorage сразу (мгновенно)
        this.loadUsers();
        
        // Параллельно загружаем из внешней БД в фоне (не блокируем)
        if (this.useExternalDB) {
    ...
    handleRegister() {
        ...
        // Загружаем из localStorage сразу (быстро)
        this.loadUsers();
        ...
        // Сохраняем во внешнюю БД в фоне (не блокируем)
    ...
    async saveUsers() {
        ...
        // Сохраняем во внешнюю БД в фоне (не блокируем UI)
        try {
